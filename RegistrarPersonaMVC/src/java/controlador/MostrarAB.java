...
public class MostrarAB extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
         PersonaAB p = new PersonaAB(); //Conectar a la BD
        ArrayList<PersonaAB> personas = new ArrayList();
        ...
        request.getRequestDispatcher("mostrartodoAB.jsp").forward(request, response);
    }
